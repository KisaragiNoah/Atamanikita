...
public class CommonConfig {
    ...
    public static final ModConfigSpec.ConfigValue<Integer> SHIFT_SPAWN_POOP_TIME;
    ...
    static {
        ...
        SHIFT_SPAWN_POOP_TIME = BUILDER
                .comment("動物からうんちが出るかロールする時間（Tick）")
                .comment("値を小さくしすぎるとパフォーマンスに重大な問題が発生する場合があります！！！")
                .defineInRange("shift_spawn_poop_time", 200, 1, Integer.MAX_VALUE);
